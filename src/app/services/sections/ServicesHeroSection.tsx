    ...
    <section className="relative bg-white py-16 lg:py-24 h-screen w-full overflow-hidden text-primary">
      <div className="container mx-auto px-4 h-full">
        <div className="flex h-full gap-8 lg:gap-10 pt-10 items-center">
          ...
          >
            <motion.h3
              className="text-lg -mb-2 leading-relaxed max-w-2xl"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.4, duration: 0.8 }}
            >
              {" "}
              Ransforming Leaders For Tommorow?
            </motion.h3>
            <motion.h1
            ...
            >
              ...
              personal, practical, and lasting. GMT International growth
              ...
              protessional. With over 20 years in the life and health sciences
              industry,
              <AnimatedUnderline underlineColor="primary" >
                President Gina Maria Thompson.
              </AnimatedUnderline>
              who coached more than 100 direct reports, mentored hundreds peers
              and students, and guided leaders to reach their fullest potential.
            </motion.p>
